...
class BeneficiaryHomeScreen extends StatefulWidget {
  final BeneficiaryAddressModel addressModel;
  const BeneficiaryHomeScreen({Key? key, required this.addressModel})
      : super(key: key);
...
class _BeneficiaryHomeScreenState extends State<BeneficiaryHomeScreen> {
  BeneficiaryHomeController getXController =
      Get.put(BeneficiaryHomeController());
  // final BeneficiaryMainScreen beneficiaryMainScreen =
  //     const BeneficiaryMainScreen();
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 30.0, right: 30.0, top: 19.0),
                  child: SizedBox(
                    height: 50,
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (query) async {
                        Get.to(() => BeneficiaryDoctorsScreen(
                              searchText:
                                  getXController.searchEditController.text,
                              fromHome: 'false',
                            ));
                      },
  ...
  getProviders() {
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemCount: getXController.providerList.length,
            ...
            return Card(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    getProviderImgPath(getXController
                                .providerList[index].providerImage) !=
                            ''
                        ? Image.network(
                            getProviderImgPath(getXController
                                .providerList[index].providerImage),
                    ...
                    Text(
                      getName(getXController.providerList[index].name),
                      style: const TextStyle(
                          fontSize: 13,
                    ...
                    Text(
                      getData(getXController.providerList[index].service),
                      style: const TextStyle(
                          fontSize: 10,
                          color: MyColor.tealBlueDark,
                          fontFamily: 'poppins_medium'),
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            '(${getData(
                              getXController
                                  .providerList[index].appointmentType,
                            )})',
                            maxLines: 1,
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            getData(
                              getXController.providerList[index].clinicAddress,
                            ),
                            maxLines: 1,
  ...
  bookNowButton(int index) {
    return Container(
      ...
      child: ElevatedButton(
          onPressed: () {
            Get.to(() => BeneficiaryBookAppointmentScreen(
                  providerId: getXController.providerList[index].providerId!,
                  appointmentType:
                      getXController.providerList[index].appointmentType != null
