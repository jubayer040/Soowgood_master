...
class BeneficiaryProfileSettingScreen extends StatefulWidget {
  ...
  @override
  _BeneficiaryProfileSettingScreenState createState() =>
      _BeneficiaryProfileSettingScreenState();
}

class _BeneficiaryProfileSettingScreenState
    extends State<BeneficiaryProfileSettingScreen> {
  BeneficiaryProfileSettingController getXController =
      Get.put(BeneficiaryProfileSettingController());
  var genderList = [
    '',
    'Male',
    'Female',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Text(
              "You have only completed ${getXController.profileScore.value}% of your profile.Please Update your details to go smoothly while booking appointment",
      ...
      children: [
        Expanded(
            ...
            child: Column(
              ...
              children: [getStarLabel('Date Of Birth'), dobField()],
            )),
        const SizedBox(
          width: 25,
        ),
        Expanded(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [getStarLabel('Gender'), genderDropdown()],
            )),
      ],
    );
  }
    ...
    return Row(
      children: [
        Expanded(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [getStarLabel('Blood Group'), bloodGroupDropdown()],
            )),
        const SizedBox(
          width: 25,
        ),
  ...
  dobField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorText: getXController.isDobEmpty.value
  ...
  fullNameField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          errorText: getXController.isFullNameEmpty.value
  ...
  userNameField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          errorText: getXController.isUserNameEmpty.value
  ...
  mobileNumberField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          errorText: getXController.isMobileNoEmpty.value
  ...
  zipCodeField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          errorText: getXController.isZipCodeEmpty.value == true
