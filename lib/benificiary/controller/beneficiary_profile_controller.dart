...
class BeneficiaryProfileController extends GetxController{
  ...
  void deleteAccountResponse() async {
      ...
      List<VerifyUserResponse>? responseModel = await repository.hitDeleteAccountApi(requestModel);
  ...
  void uploadProfilePic() async{
    ...
    bool isUploadedSuccessfully = await repository.hitUploadProfilePicApi(requestModel);
