...
class _ProviderProfileScreenState extends State<ProviderProfileScreen> {
  ProviderProfileController getXController = Get.put(ProviderProfileController());
  late Size size;
                          ...
                          : getXController.compressedImage.value != ''
                              ...
                              : Image.network(
                                  ...
                                  errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                                    return Image(image: noImage, width: 110, height: 110, fit: BoxFit.fill);
                                  },
                                ),
                ),
                Positioned(
        ...
        children: [
          ...
          Row(
            children: [
              InkWell(
                onTap: () async {
                  var result = await Get.to(() => const ProviderProfileSettingScreen());
                  if (result) {
                    Future.delayed(const Duration(), () {
                      getXController.getProfileResponse();
                    });
      ...
      child: Row(
        ...
        children: [
          ...
          Transform.scale(
            ...
            child: Switch(
              onChanged: (value) {
                getXController.isSwitchToBeneficial.value = !getXController.isSwitchToBeneficial.value;
