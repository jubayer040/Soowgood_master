...
class ProviderMedicalDocumentDialog extends StatefulWidget {
  ...
  String bookingId;
  ProviderMedicalDocumentDialog(
      {Key? key, required this.serviceReceiverId, required this.bookingId})
      : super(key: key);

  @override
  _ProviderMedicalDocumentDialogState createState() =>
      _ProviderMedicalDocumentDialogState();
}

class _ProviderMedicalDocumentDialogState
    extends State<ProviderMedicalDocumentDialog> {
  ProviderMedicalDocumentController getXController =
      Get.put(ProviderMedicalDocumentController());
                        ...
                        child: ListView.separated(
                            ...
                            separatorBuilder:
                                (BuildContext context, int index) =>
                                    const Divider(),
                            itemCount:
                                getXController.documentHistoryList.length),
                      )
                    : Center(
                        child: Container(
  ...
  Widget getDocumentWidget(int index) {
    return Column(
      ...
      children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      getXController
                          .documentHistoryList[index].scheduleAppointmentDate!,
        ...
        InkWell(
          onTap: () {
            checkStoragePermission(getXController.documentHistoryList[index]
                .documentname!); //check storage permission granted or not and if yes then download document
          },
          child: Row(
            children: [
              const Icon(
  ...
  void downloadFile(String path, String docFileName) async {
    ...
    final taskId = await FlutterDownloader.enqueue(
      url:
          '${ApiConstant.fileBaseUrl}${ApiConstant.appointmentDocFolder}/$docFileName',
      // url: imgUrl,
