...
class ProviderProfileController extends GetxController{
  ...
  void getProfileResponse() async{
    ...
    if(responseModel != null && responseModel.isNotEmpty){
      ...
      if(profileImageName.value != ""){
        imageFile = null;
        isLoad.value = false;
        profileImageUrl.value = ApiConstant.fileBaseUrl + ApiConstant.profilePicFolder + profileImageName.value;
  ...
  void deleteAccountResponse() async {
    ...
    List<VerifyUserResponse>? responseModel = await providerRepository.hitDeleteAccountApi(requestModel);
        ...
        builder: (BuildContext context1) =>
            CustomDialog(
                ...
                okBtnFunction: () async{
                  ...
                  await preferences.clear(); // clear all session data from sharedPref
 ...
 /// use to upload profile pic using  Users/ProfilePicture Api
  void uploadProfilePic() async{
    ...
    bool isUploadedSuccessfully = await providerRepository.hitUploadProfilePicApi(requestModel);
