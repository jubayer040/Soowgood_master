...
class ProviderEducationalExperienceTab extends StatefulWidget {
  ...
  @override
  _ProviderEducationalExperienceTabState createState() =>
      _ProviderEducationalExperienceTabState();
}

class _ProviderEducationalExperienceTabState
    extends State<ProviderEducationalExperienceTab> {
  ProviderEducationExperienceController getXController =
      Get.put(ProviderEducationExperienceController());
  late Size size;
  ...
  static void downloadCallback(
    ...
    final SendPort send =
        IsolateNameServer.lookupPortByName('https://api.soowgood.com')!;
          ...
          children: [
            ...
            getXController.educationList.isNotEmpty
                ...
                : const SizedBox(
                    height: 100,
                    child: Center(
                        child: Text('Education details are not available')),
                  ),
            const SizedBox(
              height: 20,
            ),
            ...
            getXController.experienceList.isNotEmpty
                ...
                : const SizedBox(
                    height: 100,
                    child: Center(
                        child: Text('Experience details are not available')),
                  ),
            const SizedBox(
              height: 20,
            ),
            ...
            getXController.documentList.isNotEmpty
                ...
                : const SizedBox(
                    height: 100,
                    child: Center(
                        child: Text('Documents details are not available')),
                  ),
          ],
        ),
      ),
                              ...
                              switch (value) {
                                case 'Edit':
                                  var result = await Get.to(
                                    () => ProviderAddEditEducationScreen(
                                      callFrom: 'Edit',
                                      educationId: getXController
                                          .educationList[index].id
                                          .toString(),
                                      degree: getXController
                                          .educationList[index].name!,
                                      college: getXController
                                          .educationList[index].institution!,
                                      year: getXController
                                          .educationList[index].yearOfCompletion
                                          .toString(),
                                    ),
                                  );
                                  ...
                                  break;
                                case 'Delete':
                                  getXController.getDeleteEducationResponse(
                                      getXController.educationList[index].id
                                          .toString());
                                  break;
                              }
                            })
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              getData(getXController
                                  .experienceList[index].hospitalName),
                              style: getNameStyle(),
                            ),
                          ],
                        ),
                        PopupMenuButton(
                            ...
                            onSelected: (value) async {
                              switch (value) {
                                case 'Edit':
                                  var result = await Get.to(
                                    () => ProviderAddEditExperienceScreen(
                                      callFrom: 'Edit',
                                      experienceId: getXController
                                          .experienceList[index].id
                                          .toString(),
                                      hospital: getXController
                                          .experienceList[index].hospitalName!,
                                      designation: getXController
                                          .experienceList[index].designation!,
                                      fromDate: getFormattedDate(getXController
                                          .experienceList[index].fromDate!),
                                      toDate: getFormattedDate(getXController
                                          .experienceList[index].toDate!),
                                    ),
                                  );
                                  ...
                                  break;
                                case 'Delete':
                                  getXController.getDeleteExperienceResponse(
                                      getXController.experienceList[index].id
                                          .toString());
                                  break;
                              }
                            })
                    ...
                    Padding(
                      ...
                      child: Text(
                        getData(
                            getXController.experienceList[index].designation),
                        style: const TextStyle(
                            color: MyColor.themeTealBlue,
                            fontSize: 13.0,
                            fontFamily: 'poppins_medium'),
              ...
              child: Column(
                ...
                children: [
                              ...
                              case 'Edit':
                                var result = await Get.to(
                                    () => ProviderAddEditDocumentScreen(
                                          callFrom: 'Edit',
                                          documentId: getXController
                                              .documentList[index].id
                                              .toString(),
                                          documentName: getXController
                                              .documentList[index]
                                              .documentname!,
                                          fileName: getXController
                                              .documentList[index]
                                              .documentfilename!,
                                        ));
                                ...
                                break;
                              case 'Delete':
                                getXController.getDeleteDocumentResponse(
                                    getXController.documentList[index].id
                                        .toString());
                                break;

                              case 'Download':
                                checkStoragePermission(getXController
                                    .documentList[index].documentfilename!);
                                break;
                            }
                          })
                    ],
                  ...
                  Padding(
                    ...
                    child: Text(
                      getData(
                          getXController.documentList[index].documentfilename),
                      style: const TextStyle(
                          color: MyColor.themeTealBlue,
                          fontSize: 13.0,
                          fontFamily: 'poppins_medium'),
  ...
  String getFormattedDate(String dateTime) {
    ...
    if (validadeSplit.length > 1) {
      ...
      stringdate = DateTime.utc(year, month, day);
      formatedDate = formatter.format(stringdate);
  ...
  void downloadFile(String path, String docFileName) async {
    ...
    String extension =
        docFileName.substring(docFileName.indexOf('.'), docFileName.length);
